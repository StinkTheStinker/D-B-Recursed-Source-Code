...
var konamiIndex:Int = 0; // Track the progress in the Konami code sequence
	...
	override function create() {
		...
		customizeAndroidControlsTipText = new FlxText(10, FlxG.height - 24, 0, 'Press X to customize your android controls!', 16);
			androidControlsStyleTipText.setFormat("Comic Sans MS Bold", 17, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
			customizeAndroidControlsTipText.setFormat("Comic Sans MS Bold", 17, FlxColor.WHITE, LEFT, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
